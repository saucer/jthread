...
void testCallbackRegister() {
  ...
  nonstd::stop_callback cb1{stok, [&] {
                              std::cout << "cb1 called\n";
                              cb1called = true;
                              // register another callback
                              std::cout << "register cb2\n";
                              nonstd::stop_callback cb2{stok, [&] {
                                                          std::cout
                                                              << "cb2 called\n";
                                                          cb2called = true;
                                                          std::cout
...
struct RegUnregCB {
  ...
  void reg(nonstd::stop_token &stok) {
...
void testCallbackConcUnregister() {
  ...
  std::optional<nonstd::stop_callback<std::function<void()>>> optCB;
  auto cb1 = [&] {
  ...
  optCB.emplace(
      stok, std::ref(cb1)); // ref() necessary because we copy to std::function
